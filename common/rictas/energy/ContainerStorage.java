...
public class ContainerStorage extends Container {
	...
	public ContainerStorage(InventoryPlayer inventoryPlayer, TileEntityEnergyStorage te) {
		tile = te;
		int upgrades = 0x0F;
		...
		addSlotToContainer(new SlotEnergyUpgrade(tile, 0, 127, 30, allowedUpgrades));
		addSlotToContainer(new SlotEnergyUpgrade(tile, 1, 151, 30, allowedUpgrades));
		addSlotToContainer(new SlotEnergyUpgrade(tile, 2, 127, 53, allowedUpgrades));
		addSlotToContainer(new SlotEnergyUpgrade(tile, 3, 151, 53, allowedUpgrades));
