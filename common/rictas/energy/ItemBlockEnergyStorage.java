...
public class ItemBlockEnergyStorage extends ItemBlock {
	...
	public final static String[] subNames = new String[] {"Energy Storage V1", "Energy Storage V2", "Energy Storage V3", "Energy Storage V4"}; 

	public ItemBlockEnergyStorage(int id) {
		super(id);
		setHasSubtypes(true);
		this.setItemName("Energy Storage");
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack,
		...
		int blockId = RictasMain.energyStorage.blockID;
